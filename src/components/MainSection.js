          ...
          <div className="row">
            <div className="col-lg-6 col-md-6 col-sm-12">
              <div className="f-colunm mt-5 pt-5 text-lg-start">
                ...
                <p className="text-black-50">
                  The Shopping is very important so we make it comfortable
                </p>
                <div className="btns d-flex justify-content-start mt-4">
                  <Link className="me-3 ps-3 pe-3 pt-2 pb-2" to="buy" id="buy">
                    Buy Now
                  </Link>
                  <Link className="ps-3 pe-3 pt-2 pb-2" to="about" id="about">
                    About Us
                  </Link>
                </div>
              </div>
            ...
            <div className="col-lg-6 col-md-6 col-sm-12">
              <div className="s-colunm">
                {scrollPostion > 170 ? (
                  <img
                    className="img-fluid ms-5 moving"
                    src={mainSectionbg}
